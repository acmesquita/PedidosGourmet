...
class PedidosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pedido" do
    assert_difference('Pedido.count') do
      post pedidos_url, params: { pedido: { person: @pedido.person, quant: @pedido.quant, when: @pedido.when } }
    end
  ...
  test "should update pedido" do
    patch pedido_url(@pedido), params: { pedido: { person: @pedido.person, quant: @pedido.quant, when: @pedido.when } }
